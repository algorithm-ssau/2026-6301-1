...
- 🟣 а) Настройка подключения к GigaChat
    Реализация модуля gigachat_connector.py (Кокорев М.) — учимся общаться с нейросетью и обрабатывать ошибки.

- 🟣 б) Проектирование базы данных
    Создание структуры SQLite, написание модуля database.py (Микуров Д.) — таблицы для расписания, дедлайнов и шагов задач.

- 🟣 в) Разработка логики напоминаний и помощника
    Создание модулей reminder_system.py и task_helper.py (Микуров Д.) — интеграция с GigaChat для генерации умных текстов.

- 🟣 г) Создание пользовательского интерфейса
    Разработка main.ipynb (Микуров Д.) — удобное меню для взаимодействия со всеми функциями бота.

- 🟣 д) Интеграция и тестирование
    Связываем все модули воедино, проверяем сценарии использования, отлавливаем баги.

- 🟣 е) Подготовка отчёта и презентации
    Оформление документации (Хархавкина М.), создание презентации (Мирошник М.), финальные коммиты (Свистун С.).
...
💟 Умные напоминания — бот не просто пишет "у вас пара", а генерирует дружеские сообщения с помощью GigaChat, подбадривая студента.

💟 Декомпозиция задач — большая курсовая работа разбивается на мелкие шаги, чтобы не было страха перед "белым листом".

💟 Всё в одном — расписание, дедлайны и напоминания собраны в единой базе данных, доступной через удобное Jupyter-меню.
